...
<html>
	<head>
		...
		function refreshData(pageNumber,pageSize){
			$("#dg").datagrid('loading');
			$.getJSON("http://localhost:8080/mytkp/index.php/Home/Class/loadClassByPage?pageNo="+pageNumber+"&pageSize="+pageSize,{},function(result){
            	...
            	<table id="formtable">
            		...
            		<tr>
            			<td align="center" colspan="2">
            				<a id="btn" href="javascript:hebingClass();" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">合并班级</a> 
            			</td>
            		</tr>
            	</table>   
            </form>  
